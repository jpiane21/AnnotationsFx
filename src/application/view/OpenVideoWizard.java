...
import application.model.FrameAnnotationManager;
...
public class OpenVideoWizard extends AnchorPane implements Initializable {
  ...
  //  WizardNavigationItem currentControl;
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		try {
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/application/view/SelectVideoPane.fxml"));
			...
			loader = new FXMLLoader(getClass().getResource("/application/view/SelectDirPane.fxml"));
			...
			loader = new FXMLLoader(getClass().getResource("/application/view/ContinueAnnotating.fxml"));
			...
			loader = new FXMLLoader(getClass().getResource("/application/view/SelectCompAnnFrame.fxml"));
			...
			loader = new FXMLLoader(getClass().getResource("/application/view/ComparePredictions.fxml"));
		...
		try {
    		String resLogin = "/application/view/Login.fxml";
    		FXMLLoader loginloader = new FXMLLoader(getClass().getResource(resLogin));
    		Parent root;
